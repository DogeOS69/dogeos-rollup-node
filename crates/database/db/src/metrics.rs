...
pub(crate) enum DatabaseOperation {
    ...
    InsertBlock,
    InsertGenesisBlock,
    DeleteMismatchedGenesisBlocks,
    ReconcileGenesisBlock,
...
impl DatabaseOperation {
    ...
    pub(crate) const fn as_str(&self) -> &'static str {
        match self {
            ...
            Self::DeleteMismatchedGenesisBlocks => "delete_mismatched_genesis_blocks",
            Self::ReconcileGenesisBlock => "reconcile_genesis_block",
